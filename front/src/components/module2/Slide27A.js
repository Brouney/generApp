...
class Slide27A extends Component {
    ...
    constructor(props){
        ...
        this.prev = <Description27 mainArea={this.mainArea}></Description27>;
        this.next = null
    ...
    render(){
        ...
        <div>
            ...
            <NavigationButtons mainArea={this.mainArea} prev={this.prev} next={this.next} currentSlideCounter={16} slidesInModuleCounter={MODULE_2_SLIDES_COUNT}
                               current={this}
            ></NavigationButtons>
        </div>
        )
